...
import { 
    ...
    AlertTriangle, CheckCircle2, Workflow, Code, Database, Radio,
    Brain, FileText, PlayCircle, HelpCircle, Server, Activity
} from 'lucide-react';
                                ...
                                {section.articles.map(article => (
                                    <li key={article.id}>
                                        <button 
                                            ...
                                            className={`w-full text-left px-4 py-2.5 text-sm rounded-md flex items-center justify-between transition-all duration-200 group ${
