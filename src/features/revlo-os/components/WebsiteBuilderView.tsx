...
import { Monitor, Smartphone, RefreshCw, Send, Layers, Edit, Code, Eye } from 'lucide-react';
      ...
      <div className="flex-1 bg-slate-950 flex flex-col relative overflow-hidden">
        ...
        <div className="h-48 bg-slate-900 border-t border-slate-800 p-4 flex flex-col z-10">
          <div className="flex justify-between items-center mb-2">
            <h4 className="text-sm font-bold text-accent-500 flex items-center"><Edit size={14} className="mr-2" /> AI Pinpoint Editor</h4>
            <select
