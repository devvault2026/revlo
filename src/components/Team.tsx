...
const Team: React.FC = () => {
    const teamMembers = [
        ...
        },
        {
            ...
            bio: 'A former celebrity magician who transforms mindset and presence into AI autonomy. Paul orchestrates complex multi-agent systems with the precision of a master magician executing the impossible.',
            expertise: ['Autonomous Orchestration', 'Multi-Agent Systems', 'AI Mindset'],
            color: 'text-purple-400',
            initial: 'PC',
