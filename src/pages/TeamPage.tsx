...
import { Linkedin, Mail, ArrowRight, UserCheck } from 'lucide-react';
                                ...
                                <div className="text-center lg:text-left">
                                    ...
                                    <Link to={`/team/${member.slug}`}>
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.95 }}
                                            className="w-full px-6 py-3 bg-white/10 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-2 italic"
                                        >
                                            View Profile
